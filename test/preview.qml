        ...
        Column {
            ...
            Row {
                ...
                Button {
                    ...
                    variant: "outline"
                    size: "md"
                    onClicked: Qt.createQmlObject('import QtQuick 2.15; import QtQuick.Window 2.15; Window { width: 1280; height: 800; visible: true; Loader { anchors.fill: parent; source: "dashboard.qml" } }', window);
                }
            }
