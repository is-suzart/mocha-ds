...
export const COMPONENTS: ComponentDefinition[] = [
  {
    ...
    "props": [
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Rótulo visível do botão"
      },
      {
        "name": "variant",
        "type": "string",
      ...
      },
      {
        ...
        "description": "Cor de accent (14 cores Catppuccin)"
      },
      {
        "name": "size",
        "type": "string",
      ...
      },
      {
        ...
        "description": "Formato dos cantos"
      },
      {
        "name": "disabled",
        "type": "bool",
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Ícone Lucide à esquerda"
      },
      {
        "name": "rightIcon",
        "type": "string",
        "default": "\"\"",
        "description": "Ícone Lucide à direita"
      },
      {
        "name": "customRadius",
        "type": "real",
    ...
    "signals": [
      {
        "name": "clicked",
        "description": "Emitido ao clicar no botão"
      }
    ],
    "slots": [
    ...
    "props": [
      {
        ...
        "type": "int",
        "default": "0",
        "description": "Índice do item ativo"
      },
      {
        "name": "variant",
        "type": "string",
        ...
        "description": "Estilo do grupo"
      },
      {
        "name": "expand",
        "type": "bool",
        "default": "true",
        "description": "Distribui largura igualmente"
      }
    ],
    "slots": [
      "content (default) — ButtonGroupItems"
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Ícone Lucide"
      },
      {
        "name": "badgeText",
        "type": "string",
        "default": "\"\"",
        "description": "Badge numérico"
      }
    ],
    "signals": [
      {
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Mensagem de erro (ativa shake)"
      },
      {
        "name": "customRadius",
        "type": "real",
        "default": "-1",
        "description": "Raio customizado"
      },
      {
        "name": "customBorderColor",
        "type": "color",
        "default": "transparent",
        "description": "Borda customizada"
      },
      {
        "name": "customBackgroundColor",
        "type": "color",
        "default": "transparent",
        "description": "Fundo customizado"
      }
    ],
    "signals": [
      {
        "name": "accepted",
        "description": "Enter pressionado"
      },
      {
        "name": "textEdited",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "description": "sm=36x20, md=44x24, lg=56x32"
      },
      {
        "name": "label",
        "type": "string",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "description": "sm=14px, md=18px, lg=22px"
      },
      {
        "name": "checked",
        "type": "bool",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "description": "Espaço entre radios"
      }
    ],
    "slots": [
      "content (default)"
    ...
    "props": [
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "Array de strings ou [{value, label}]"
      },
      {
        "name": "selectedValue",
        "type": "var",
      ...
      },
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Forçar aberto"
      },
      {
        "name": "openUpward",
        "type": "bool",
        "default": "false",
        "description": "Abre para cima"
      }
    ],
    "signals": [
      {
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "Valores selecionados (multi)"
      },
      {
        "name": "placeholder",
        "type": "string",
      ...
      },
      {
        ...
        "type": "bool",
        "default": "true",
        "description": "Permite múltipla seleção"
      },
      {
        "name": "size",
        "type": "string",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "description": "Espessura: sm=4px, md=6px, lg=8px"
      }
    ],
    ...
    "signals": [
      {
        "name": "completed",
        "params": "string code",
        "description": "Todos os slots preenchidos"
      },
      {
        "name": "accepted",
        "description": "Enter pressionado"
  ...
  },
  {
    ...
    "signals": [
      {
        "name": "colorChanged",
        "params": "string newHex",
        "description": "Cor mudou"
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Mostra X de dismiss"
      },
      {
        "name": "showDot",
        "type": "bool",
        "default": "false",
        "description": "Dot indicador"
      }
    ],
    "signals": [
      {
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "int",
        "default": "3000",
        "description": "Auto-dismiss em ms"
      },
      {
        "name": "showClose",
        "type": "bool",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Modo tela cheia"
      },
      {
        "name": "label",
        "type": "string",
        "default": "\"\"",
        "description": "Texto (apenas overlay)"
      },
      {
        "name": "overlayColor",
        "type": "color",
        "default": "crust @ 85%",
        "description": "Cor do backdrop"
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "description": "sm=400px, md=600px, lg=800px"
      },
      {
        "name": "customWidth",
        "type": "real",
        "default": "-1",
        "description": "Largura customizada"
      },
      {
        "name": "customHeight",
        "type": "real",
        "default": "-1",
        "description": "Altura customizada"
      },
      {
        "name": "closeOnBackdropClick",
        "type": "bool",
        "default": "true",
        "description": "Fecha no backdrop"
      },
      {
        "name": "closeOnEscape",
        "type": "bool",
        "default": "true",
        "description": "Fecha com Esc"
      },
      {
      ...
      },
      {
        ...
        "type": "bool",
        "default": "true",
        "description": "Hoist para janela raiz"
      }
    ],
    "signals": [
      {
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "real",
        "default": "360",
        "description": "Largura ou altura em px"
      },
      {
        "name": "closeOnBackdropClick",
        "type": "bool",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"Confirmar\"",
        "description": "Label confirmar"
      },
      {
        "name": "cancelLabel",
        "type": "string",
        "default": "\"Cancelar\"",
        "description": "Label cancelar"
      },
      {
        "name": "showCancel",
        "type": "bool",
        "default": "true",
        "description": "Exibe cancelar"
      }
    ],
    "signals": [
      {
        "name": "confirmed",
        "description": "Confirmou"
      },
      {
        "name": "cancelled",
    ...
    "props": [
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "[{label, icon, shortcut, separator, onClicked}]"
      },
      {
        "name": "open",
        "type": "bool",
    ...
    "props": [
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "[{label, icon, shortcut, variant, disabled, separator, onClicked, keepOpen}]"
      },
      {
        "name": "placement",
        "type": "string",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "description": "Posição do accent"
      },
      {
        "name": "clickable",
        "type": "bool",
        "default": "false",
        "description": "Hover/press com micro-animação"
      },
      {
        "name": "padding",
        "type": "real",
        "default": "Theme.spacing.lg",
        "description": "Padding do body"
      },
      {
        "name": "backgroundColor",
        "type": "string",
        "default": "\"\"",
        "description": "Cor Catppuccin (variant=filled)"
      },
      {
        "name": "headerSeparator",
        "type": "bool",
        "default": "true",
        "description": "Separador após header"
      },
      {
        "name": "footerSeparator",
        "type": "bool",
        "default": "true",
        "description": "Separador antes do footer"
      },
      {
        "name": "customRadius",
        "type": "real",
    ...
    "signals": [
      {
        "name": "clicked",
        "description": "Card clicado (clickable=true)"
      }
    ],
    "slots": [
      "header: list<Item>",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "bool",
        "default": "true",
        "description": "Habilita interação"
      },
      {
        "name": "accentColor",
        "type": "string",
        "default": "\"mauve\"",
        "description": "Cor do accent"
      }
    ],
    "signals": [
      {
        "name": "toggled",
        "params": "bool isExpanded",
        "description": "Estado mudou"
      }
    ],
    "slots": [
    ...
    "props": [
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "Strings ou [{id, label, icon}]"
      },
      {
        "name": "currentIndex",
        "type": "int",
      ...
      },
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Habilita reordenação por drag & drop"
      }
    ],
    "signals": [
      {
        "name": "tabSelected",
        "params": "int index, string tabId",
        "description": "Aba selecionada"
      },
      {
        "name": "tabsReordered",
        "params": "int fromIndex, int toIndex",
        "description": "Emitido ao reordenar abas via drag & drop"
      }
    ],
    ...
    "props": [
      {
        ...
        "type": "real",
        "default": "Theme.spacing.md",
        "description": "Espaço entre filhos"
      },
      {
        "name": "padding",
        "type": "real",
    ...
    "props": [
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Colapsa em 1 coluna no mobile"
      },
      {
        "name": "multiline",
        "type": "bool",
        "default": "true",
        "description": "Wrap para próxima linha"
      },
      {
        "name": "gap",
        "type": "int",
        "default": "3",
        "description": "Espaço entre colunas (0-5)"
      },
      {
        "name": "align",
        "type": "string",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "int",
        "default": "-1",
        "description": "Span tablet"
      },
      {
        "name": "lg",
        "type": "int",
        "default": "-1",
        "description": "Span desktop"
      },
      {
        "name": "offset",
        "type": "int",
        "default": "0",
        "description": "Offset de colunas"
      }
    ],
    "slots": [
      "content (default)"
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "required": true,
        "default": "(obrigatório)",
        "description": "Template de linha"
      },
      {
        "name": "spacing",
        "type": "real",
        "default": "Theme.spacing.sm",
        "description": "Espaço entre linhas"
      },
      {
        "name": "emptyStateIcon",
        "type": "string",
        "default": "\"package-open\"",
        "description": "Ícone empty state"
      },
      {
        "name": "emptyStateTitle",
        "type": "string",
        "default": "\"Nenhum item\"",
        "description": "Título empty state"
      },
      {
        "name": "emptyStateSubtitle",
        "type": "string",
        "default": "\"\"",
        "description": "Subtítulo empty state"
      },
      {
        "name": "isLoading",
        "type": "bool",
        "default": "false",
        "description": "Exibe skeletons"
      },
      {
        "name": "sortable",
        "type": "bool",
        "default": "false",
        "description": "Habilita D&D"
      },
      {
        "name": "listId",
        "type": "string",
        "default": "\"\"",
        "description": "ID único (D&D entre listas)"
      }
    ],
    "signals": [
      {
    ...
    "props": [
      {
        ...
        "type": "var",
        "required": true,
        "description": "Fonte de dados (JS Array ou ListModel)"
      },
      {
        "name": "delegate",
        "type": "Component",
        "required": true,
        "description": "Template visual de cada item"
      },
      {
        "name": "spacing",
        "type": "real",
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "ID único da lista (para D&D entre múltiplas colunas)"
      },
      {
        "name": "dragKey",
        "type": "string",
        "default": "\"mochads-sortable\"",
        "description": "Chave interna para combinar drags compatíveis"
      },
      {
        "name": "sortable",
        "type": "bool",
        "default": "true",
        "description": "Habilita ou desabilita reordenação"
      }
    ],
    "signals": [
      {
        "name": "itemsReordered",
        "params": "int fromIndex, int toIndex",
        "description": "Emitido ao reordenar item na mesma lista. Sincronize seu array/model aqui!"
      },
      {
        "name": "externalItemDropped",
        "params": "var source, int insertIndex",
        "description": "Emitido ao receber um item de outra lista"
      }
    ],
    ...
    "props": [
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "Configuração das colunas: [{name, label, width, sortable, type}]"
      },
      {
        "name": "rows",
        "type": "var",
        "default": "[]",
        "description": "Dados das linhas"
      },
      {
        "name": "selectedIndexes",
        "type": "var",
        "default": "[]",
        "description": "Índices das linhas selecionadas"
      },
      {
        "name": "sortColumn",
        "type": "string",
        "default": "\"\"",
        "description": "Coluna de ordenação atual"
      },
      {
        "name": "sortOrder",
        "type": "string",
      ...
      },
      {
        ...
        "type": "bool",
        "default": "true",
        "description": "Exibe rodapé de paginação"
      },
      {
        "name": "selectable",
        "type": "bool",
        "default": "true",
        "description": "Habilita seleção de linhas"
      },
      {
        "name": "dragToReorder",
        "type": "bool",
        "default": "false",
        "description": "Habilita drag & drop para reordenar linhas"
      }
    ],
    "signals": [
      {
        "name": "selectionChanged",
        "params": "var indexes",
        "description": "Seleção alterada"
      },
      {
        "name": "sortChanged",
        "params": "string column, string order",
        "description": "Coluna de ordenação alterada"
      },
      {
        "name": "rowsReordered",
        "params": "int fromIndex, int toIndex",
        "description": "Linhas reordenadas via drag. Sincronize a array de rows aqui!"
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "Dados em formato de árvore contendo filhos (.children)"
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Expande ao hover (quando colapsada)"
      },
      {
        "name": "collapsedWidth",
        "type": "real",
        "default": "68",
        "description": "Largura colapsada"
      },
      {
        "name": "expandedWidth",
        "type": "real",
        "default": "260",
        "description": "Largura expandida"
      },
      {
        "name": "header",
        "type": "list<Item>",
        "default": "[]",
        "description": "Slot livre: qualquer Item no topo. Alternativa ao SidebarHeader."
      },
      {
        "name": "footer",
        "type": "list<Item>",
        "default": "[]",
        "description": "Slot livre: qualquer Item no rodapé. Alternativa ao SidebarFooter."
      }
    ],
    "slots": [
      "header: list<Item>",
      "footer: list<Item>",
      "content (default) — SidebarHeader/Footer/Section"
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Ícone Lucide do logo"
      }
    ],
    "slots": [
      "content (default) — conteúdo customizado (sobrepõe o default layout)"
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"user\"",
        "description": "Ícone Lucide do avatar"
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Sub-itens expandidos"
      }
    ],
    "signals": [
      {
    ...
    "slots": [
      "subContent (default) — SidebarItems aninhados"
    ],
    ...
    "props": [
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "[{label, onClicked}]"
      },
      {
        "name": "separator",
        "type": "string",
        "default": "\"chevron-right\"",
        "description": "Ícone separador"
      },
      {
        "name": "size",
        "type": "string",
    ...
    "props": [
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Nome completo (gera iniciais)"
      },
      {
        "name": "src",
        "type": "string",
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Ícone Lucide (fallback)"
      },
      {
        "name": "size",
        "type": "string",
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"mauve\"",
        "description": "Cor do fundo"
      },
      {
        "name": "showStatus",
        "type": "bool",
        "default": "false",
        "description": "Dot de status"
      },
      {
        "name": "status",
        "type": "string",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Asterisco obrigatório"
      },
      {
        "name": "status",
        "type": "string",
    ...
    "props": [
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Chave de drag (deve combinar com DropZone.acceptedKeys)"
      },
      {
        "name": "dragData",
        "type": "var",
        "default": "null",
        "description": "Dados passados para a DropZone"
      },
      {
        "name": "enabled",
        "type": "bool",
        "default": "true",
        "description": "Habilita drag"
      },
      {
        "name": "threshold",
        "type": "real",
        "default": "8",
        "description": "Pixels mínimos para ativar drag"
      },
      {
        "name": "dragScale",
        "type": "real",
        "default": "1.05",
        "description": "Escala ao arrastar"
      },
      {
        "name": "dragOpacity",
        "type": "real",
        "default": "0.9",
        "description": "Opacidade ao arrastar"
      }
    ],
    "signals": [
      {
        "name": "dragStarted",
        "params": "var data",
        "description": "Drag iniciado"
      },
      {
        "name": "dragEnded",
        "params": "var data",
        "description": "Drag finalizado"
      },
      {
        "name": "clicked",
        "description": "Clicado sem arrastar"
      }
    ],
    ...
    "props": [
      {
        ...
        "type": "var",
        "default": "[]",
        "description": "Chaves de drag aceitas"
      },
      {
        "name": "isActive",
        "type": "bool",
        "default": "false",
        "description": "(readonly) drag compatível acima"
      }
    ],
    "signals": [
      {
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "bool",
        "default": "true",
        "description": "Inicia a animação"
      },
      {
        "name": "delay",
        "type": "int",
        "default": "0",
        "description": "Delay antes de iniciar"
      }
    ],
    "slots": [
      "content (default)"
    ...
    "props": [
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "true=entra, false=sai"
      },
      {
        "name": "enterAnimation",
        "type": "string",
      ...
      },
      {
        ...
        "description": "Animação de saída"
      },
      {
        "name": "enterDuration",
        "type": "int",
        "default": "300",
        "description": "Duração de entrada em ms"
      },
      {
        "name": "exitDuration",
        "type": "int",
        "default": "200",
        "description": "Duração de saída em ms"
      },
      {
        "name": "enterOffset",
        "type": "real",
        "default": "20",
        "description": "Offset da animação de entrada"
      }
    ],
    "slots": [
      "content (default)"
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Prefixo (ex: 'R$ ')"
      },
      {
        "name": "suffix",
        "type": "string",
        "default": "\"\"",
        "description": "Sufixo (ex: '%')"
      },
      {
        "name": "separator",
        "type": "string",
        "default": "\"\"",
        "description": "Separador de milhar"
      }
    ],
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "bool",
        "default": "false",
        "description": "Detecta claro/escuro do sistema"
      }
    ],
    ...
    "props": [
      {
        ...
        "type": "string",
        "default": "\"en\"",
        "description": "Locale ativo. Ao mudar, recarrega o JSON automaticamente."
      },
      {
        "name": "fallbackLocale",
        "type": "string",
        "default": "\"en\"",
        "description": "Locale de fallback"
      },
      {
        "name": "basePath",
        "type": "string",
        "default": "\"\"",
        "description": "Caminho base para os arquivos JSON"
      },
      {
        "name": "isReady",
        "type": "bool",
        "default": "false",
        "description": "(readonly) JSON carregado"
      },
      {
        "name": "debugMode",
        "type": "bool",
        "default": "false",
        "description": "Exibe ⚠️ na UI para chaves não encontradas"
      }
    ],
    "methods": [
      "t(key, params?): string",
    ...
    "signals": [
      {
        ...
        "params": "string key, string locale",
        "description": "Chave não encontrada (debugMode=true)"
      }
    ],
    ...
    "props": [
      {
        ...
        "default": "\"\"",
        "required": true,
        "description": "Nome do ícone Lucide (ex: 'home', 'trash-2')"
      },
      {
        "name": "size",
        "type": "real",
    ...
    "props": [
      {
        ...
        "type": "string",
        "default": "\"/\"",
        "description": "Rota a ser carregada inicialmente"
      },
      {
        "name": "transitionDuration",
        "type": "int",
        "default": "220",
        "description": "Duração em ms do fade entre rotas (0 para desativar)"
      },
      {
        "name": "notFoundComponent",
        "type": "Component",
        "default": "null",
        "description": "Componente customizado para rotas 404"
      }
    ],
    "signals": [
      {
        "name": "navigationStarted",
        "params": "string path, var params",
        "description": "Navegação para um caminho iniciada"
      },
      {
        "name": "navigationFinished",
        "params": "string path, var params",
        "description": "Navegação finalizada e página carregada"
      },
      {
        "name": "routeNotFound",
        "params": "string path",
        "description": "Tentativa de navegar para uma rota inexistente"
      }
    ],
    "methods": [
      "push(path, params?)",
    ...
    "props": [
      {
        ...
        "default": "\"\"",
        "required": true,
        "description": "Caminho da rota (ex: '/users/:id')"
      },
      {
        "name": "source",
        "type": "string",
        "default": "\"\"",
        "description": "URL do arquivo QML (resolvido por Qt.resolvedUrl)"
      },
      {
        "name": "view",
        "type": "Component",
        "default": "null",
        "description": "Componente inline para exibição"
      },
      {
        "name": "title",
        "type": "string",
        "default": "\"\"",
        "description": "Título amigável para breadcrumbs ou metadados"
      }
    ],
    ...
    "props": [
      {
        ...
        "default": "\"\"",
        "required": true,
        "description": "Caminho de destino (ex: '/settings')"
      },
      {
        "name": "params",
        "type": "var",
        "default": "{}",
        "description": "Parâmetros adicionais de rota"
      },
      {
        "name": "router",
        "type": "var",
        "default": "null",
        "description": "Instância do Router (detectado por parent se omitido)"
      },
      {
        "name": "action",
        "type": "string",
      ...
      },
      {
        ...
        "type": "string",
        "default": "\"\"",
        "description": "Texto rápido do link"
      },
      {
        "name": "icon",
        "type": "string",
        "default": "\"\"",
        "description": "Ícone Lucide rápido"
      },
      {
        "name": "activeColor",
        "type": "color",
        "default": "Theme.colors.primary",
        "description": "Cor do link quando ativo"
      },
      {
        "name": "inactiveColor",
        "type": "color",
        "default": "Theme.colors.text",
        "description": "Cor do link quando inativo"
      }
    ],
    "example": "RouterLink {\n    to: \"/settings\"\n    text: \"Configurações\"\n    icon: \"settings\"\n}"
  }
