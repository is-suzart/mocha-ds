...
export declare class NativeApp {
  ...
  setShellWindowProps(opts: { title?: string; width?: number; height?: number }): void;
  setProperty(property: string, value: any): void;
  getProperty(property: string): string;
  createProxy(): number;
  proxySetValue(proxyId: number, name: string, value: any): void;
  ...
  setObjectProperty(objId: number, name: string, value: any): void;
  processEvents(): void;
  exec(): number;
  quit(): void;
  registerAppObjects(): void;
  listRootObjects(): Array<{ id: number; className: string; objectName: string; children: any[] }>;
  listChildren(objId: number): Array<{ id: number; className: string; objectName: string; children: any[] }>;
  getQmlProperty(objId: number, name: string): string;
  getQmlProperties(objId: number): Array<{ n: string; t: string; v: string; r: boolean; w: boolean }>;
